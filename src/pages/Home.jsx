  ...
  return (
    <div className="home container-fluid g-0">
        ...
        <div className="home-content">
            ...
            <div className="accueil  d-flex justify-content-center align-items-center flex-column">
                <div className="titles p-4 mt-5">
                    <h1 className='text-center main-title'>WELCOME</h1>
                    <h2 className='text-center'> MY NAME IS <i class="fa-solid fa-star"></i> FATYA </h2> 
                    <h3 className='text-center'> AND I'M DEVELOPPER WEB </h3>
                </div>
                <div className="socials align-self-end ">
                    <ul className=''>
                    <a href="https://github.com/xkedass" target="blank" rel="noopener noreferer"> 
            ...
            <div className="row">
                <div className="col-6 side-left ">
                    <div className="logo d-flex justify-content-center align-items-center flex-column">
                        ...
                        <a className="text-center" href="./medias/CV Fatiha SADEQ - Développeuse Web (1).pdf" target="blank"> TELECHARGEZ MON CV</a>
                    </div>
                </div>
