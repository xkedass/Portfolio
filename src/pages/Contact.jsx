...
export default function Contact() {
  const schema = yup.object({
    name: yup.string().max(50).min(2,'coucou').required("merci de rentrer votre nom"),
    firstName: yup.string().max(50).required("merci de rentrer votre prénom"),
    email : yup.string().email('merci de saisir un email valide').max(250).required('merci de saisir un email'),
  ...
  return (
    ...
    <>
    <div className="contact container-fluid g-0 mt-5" id="contact">
        ...
        <div className="col-12 d-flex justify-content-center">
          ...
          <div className="col-6 side-right d-flex justify-content-center align-items-center flex-column">
           <ul>
            <li>Fatiha SADEQ</li>
            <li> +330781757790</li>
            <li>sadeq.fatiha@hotmail.com</li>
           </ul>
          </div>
        </div>
      </div>
